...
TRACKS = {
    ...
    "cloud-devops": {"name": "Cloud / DevOps", "description": "Build, deploy, monitor, and improve reliable software delivery.", "skills": [("python", "Python", "programming_language", "intermediate", "high"), ("linux", "Linux", "core_cs", "intermediate", "high"), ("docker", "Docker", "cloud_devops", "intermediate", "high"), ("cloud", "Cloud Fundamentals", "cloud_devops", "intermediate", "high"), ("git", "Git", "cloud_devops", "intermediate", "medium")]},
    "qa-engineer": {"name": "QA Engineer", "description": "Validate software quality through thoughtful manual and automated testing.", "skills": [("testing", "Software Testing", "core_cs", "intermediate", "high"), ("python", "Python", "programming_language", "beginner", "high"), ("api-testing", "API Testing", "framework", "intermediate", "high"), ("sql", "SQL", "database", "beginner", "medium"), ("communication", "Communication", "soft_skill", "intermediate", "medium")]},
}
